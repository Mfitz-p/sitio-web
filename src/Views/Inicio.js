      ...
      <Container fluid className='hideX'>
        <section id='cards-servicios'>
            ...
            <Col className='d-flex flex-row' >
              <Card className="p-5 " style={{ border: 'none' }}>
                <Card.Body className='animate__animated animate__pulse'>
                  <Card.Title className='subrayado d-flex justify-content-center px-5' style={{ fontSize: "3rem", textAlign: "justify" }}>
                    ¿Qué hacemos por ti?
                  </Card.Title>
         ...
         {/*  Ícono de la flecha que redirige a la sección inicial de la vista */}
            ...
            <Col className="d-flex align-items-center g-0" lg={6} md={12}>
              <Card className="p-1 g-0" style={{ border: 'none' }} >
                <Card.Body ref={textcard1} className={`${effectScroll ? 'animate__animated animate__fadeInLeft' : 'reverseObserver'}`}>
                  <Card.Title className="m-5 mb-0" style={{ fontSize: '50px', fontWeight: 'bold', textDecoration: 'underline', textDecorationColor: '#6BBBAE' }}>
                    Infraestructura
                  </Card.Title>
                  <Card.Text className='m-5 mt-2 mb-2 pe-4' style={{ fontSize: '18px', textAlign: 'justify' }}>
                  ...
                  <Card.Link className="m-5 mb-0" as={NavLink} to="/Productos#infraestructura">Ver más...</Card.Link>
                </Card.Body>
              </Card>
            </Col>
          ...
          <Row className='mx-5'>
            <Col id="imagenInicio" md={{order:"last", span:12}} lg={{order:"first", span:6}}>
              <Image fluid src={retail} alt='img-page' ref={imgcard2} className={`${effectImgScroll2 ? 'animate__animated animate__fadeInLeft' : 'reverseObserver'}`} style={{ objectFit: 'cover', height: '39.3rem' }} />
            </Col>
            <Col className="d-flex align-items-center g-0" md={{order:"first", span:12}} lg={{order:"last", span:6}}>
              <Card className="p-1" style={{ border: 'none' }}>
                <Card.Body ref={textcard2} className={`${effectScroll2 ? 'animate__animated animate__fadeInRight' : 'reverseObserver'}`}>
                  <Card.Title className="m-5 mb-0 ps-4" style={{ fontSize: '50px', fontWeight: 'bold', textDecoration: 'underline', textDecorationColor: '#6BBBAE' }}>
                    Retail & B2B
                  </Card.Title>
                  <Card.Text className='m-5 mt-2 mb-2 ps-4' style={{ fontSize: '18px', textAlign: 'justify' }}>
                  ...
                  <Card.Link className="m-5 mb-0 ps-4" as={NavLink} to="/Productos#retail">Ver más...</Card.Link>
                </Card.Body>
              </Card>
            </Col>
          </Row>
            ...
            <Col className="d-flex align-items-center g-0" lg={6} md={12}>
              <Card className="p-1" style={{ border: 'none' }}>
                <Card.Body ref={textcard3} className={`${effectScroll3 ? 'animate__animated animate__fadeInLeft' : 'reverseObserver'}`}>
                  ...
                  <Card.Link className="m-5 mb-0" as={NavLink} to="/Productos#salud">Ver más...</Card.Link>
                </Card.Body>
              </Card>
            </Col>
            <Col id="imagenInicio" lg={6} md={12}>
            ...
            <Col className="d-flex align-items-center g-0" md={{order:"first", span:12}} lg={{order:"last", span:6}}>
              <Card className="p-1" style={{ border: 'none' }}>
                <Card.Body ref={textcard4} className={`${effectScroll4 ? 'animate__animated animate__fadeInRight' : 'reverseObserver'}`}>
                  <Card.Title className="m-5 mb-0 ps-4" style={{ fontSize: '45px', fontWeight: 'bold', textDecoration: 'underline', textDecorationColor: '#6BBBAE' }}>
                    Movilidad y Transportes
                  </Card.Title>
                  <Card.Text className='m-5 mt-2 mb-2 ps-4' style={{ fontSize: '18px', textAlign: 'justify' }}>
                  Optimizamos tus estrategias de venta mediante la implementación de analítica descriptiva y predictiva del comportamiento del consumidor en tu negocio. 
                  </Card.Text>
                  <Card.Link as={NavLink} className="m-5 mb-0 ps-4" to="/Productos#movilidad">Ver más...</Card.Link>
                </Card.Body>
              </Card>
            </Col>
          </Row>
            ...
            <Col className="d-flex align-items-center g-0" lg={6} md={12}>
              <Card className="p-1" style={{ border: 'none' }}>
                <Card.Body ref={textcard5} className={`${effectScroll5 ? 'animate__animated animate__fadeInLeft' : 'reverseObserver'}`}>
                  ...
                  <Card.Link className="mx-5 " as={NavLink} to="/Productos#banca">Ver más...</Card.Link>
                </Card.Body>
              </Card>
            </Col>
            <Col id="imagenInicio" lg={6} md={12}>
